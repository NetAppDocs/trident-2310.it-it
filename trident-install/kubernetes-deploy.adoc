...
[%collapsible]
====
Con Astra Trident usando NetApp Console, puoi aggiornare all'ultima versione di Astra Trident, aggiungere e gestire classi di storage e collegarle agli ambienti di lavoro, e eseguire il backup dei volumi persistenti usando Cloud Backup Service. BlueXP supporta la distribuzione di Astra Trident tramite l'operatore Trident, sia manualmente che usando Helm.
