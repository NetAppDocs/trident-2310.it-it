...
|===
Ad esempio, per modificare il valore predefinito di `debug`, eseguire quanto segue `--set` comando dove `23.10.0` È la versione di Astra Trident che si sta installando:
...
| `tridentControllerPluginNodeSelector` | Selettori di nodo aggiuntivi per i pod. Consulta link:../trident-get-started/architecture.html#understanding-controller-pods-and-node-pods["Comprensione dei pod controller e dei pod di nodi"] per i dettagli. |  


| `tridentControllerPluginTolerations` | Sostituisce le tolleranze di Kubernetes per i pod. Consulta link:../trident-get-started/architecture.html#understanding-controller-pods-and-node-pods["Comprensione dei pod controller e dei pod di nodi"] per i dettagli. |  


| `tridentNodePluginNodeSelector` | Selettori di nodo aggiuntivi per i pod. Consulta link:../trident-get-started/architecture.html#understanding-controller-pods-and-node-pods["Comprensione dei pod controller e dei pod di nodi"] per i dettagli. |  


| `tridentNodePluginTolerations` | Sostituisce le tolleranze di Kubernetes per i pod. Consulta link:../trident-get-started/architecture.html#understanding-controller-pods-and-node-pods["Comprensione dei pod controller e dei pod di nodi"] per i dettagli. |  
